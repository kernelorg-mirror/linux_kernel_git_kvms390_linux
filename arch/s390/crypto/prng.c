/*
 * Copyright IBM Corp. 2006, 2007, 2015
...
static unsigned char initial_parm_block[32] = {
...
static inline void stcke(u8 clk[16])
{
...
static int prng_tdes_instantiate(void)
{
	int datalen;
	...
	prng_data = kmalloc(datalen, GFP_KERNEL);
	if (!prng_data) {
		prng_errorflag = PRNG_INSTANTIATE_FAILED;
		return -ENOMEM;
	}
	memset(prng_data, 0, datalen);
...
static int prng_sha512_selftest(void)
{
	/* NIST DRBG testvector for Hash Drbg, Sha-512, Count #0 */
	u8 seed[]   = { 0x6b, 0x50, 0xa7, 0xd8, 0xf8, 0xa5, 0x5d, 0x7a,
			0x3d, 0xf8, 0xbb, 0x40, 0xbc, 0xc3, 0xb7, 0x22,
			0xd8, 0x70, 0x8d, 0xe6, 0x7f, 0xda, 0x01, 0x0b,
			0x03, 0xc4, 0xc8, 0x4d, 0x72, 0x09, 0x6f, 0x8c,
			0x3e, 0xc6, 0x49, 0xcc, 0x62, 0x56, 0xd9, 0xfa,
			0x31, 0xdb, 0x7a, 0x29, 0x04, 0xaa, 0xf0, 0x25 };
	u8 V0[]     = { 0x00, 0xad, 0xe3, 0x6f, 0x9a, 0x01, 0xc7, 0x76,
	...
	u8 C0[]     = { 0x00, 0xf4, 0xa3, 0xe5, 0xa0, 0x72, 0x63, 0x95,
	...
	u8 random[] = { 0x95, 0xb7, 0xf1, 0x7e, 0x98, 0x02, 0xd3, 0x57,
...
static int prng_sha512_instantiate(void)
{
	int ret, datalen;
	u8 seed[64];
			      ...
			      size_t nbytes, loff_t *ppos)
{
	...
	while (nbytes) {
		...
		*((unsigned long long *)prng_data->buf) = stckf();
