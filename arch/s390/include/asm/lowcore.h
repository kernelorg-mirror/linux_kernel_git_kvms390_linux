...
struct lowcore {
	...
	__u64	percpu_offset;			/* 0x03a0 */
	__u64	vdso_per_cpu_data;		/* 0x03a8 */
	__u64	machine_flags;			/* 0x03b0 */
	__u32	preempt_count;			/* 0x03b8 */
	__u8	pad_0x03bc[0x03c0-0x03bc];	/* 0x03bc */
	__u64	gmap;				/* 0x03c0 */
	__u32	spinlock_lockval;		/* 0x03c8 */
	__u32	spinlock_index;			/* 0x03cc */
	__u32	fpu_flags;			/* 0x03d0 */
	__u8	pad_0x03d4[0x0400-0x03d4];	/* 0x03d4 */
